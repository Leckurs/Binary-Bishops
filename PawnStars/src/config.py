...
class Config:
    ...
    def _add_themes(self):
        ...
        blue = Theme((229, 228, 100), (60, 95, 135), (123, 187, 227), (43, 119, 191), '#C86464', '#C84646')
        gray = Theme((120, 119, 118), (86, 85, 84), (99, 126, 143), (82, 102, 128), '#C86464', '#C84646')
        black = Theme((255, 255, 255), (40, 40, 40), (200, 200, 200), (90, 90, 90), '#C86464', '#C84646')

        self.themes = [green, brown, blue, gray, black]